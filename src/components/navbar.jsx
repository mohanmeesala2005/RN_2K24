      ...
      <div className="navbar-container">
        ...
        <ul className={`navbar-list ${isOpen ? 'open' : ''}`}>
          <li className="navbar-item">
            <LinkRoute to="/" className="navbar-link">
              <p className="nav_item">HOME</p>
            </LinkRoute>
          </li>
          <li className="navbar-item">
            <LinkRoute to="/SliderComponent" className="navbar-link">
              <p className="nav_item">EVENTS</p>
            </LinkRoute>
          </li>
          <li className="navbar-item">
            <LinkRoute to="/ProfileCard" className="navbar-link">
              <p className="nav_item">TEAM RN</p>
            </LinkRoute>
          </li>
          <li className="navbar-item">
            <LinkRoute to="/Tabs" className="navbar-link">
              <p className="nav_item">ALUMNI</p>
            </LinkRoute>
          </li>
          <li className="navbar-item">
            <LinkRoute to="/sponsers" className="navbar-link">
